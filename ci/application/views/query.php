...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("contents3").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","query3",true);
xmlhttp.send();
}
...
<?php if($log == "loggedin"){?>
<button type="button" id="user" class="btn btn-lg btn-info" data-container="body" data-toggle="popover" title="username" data-placement="bottom" style="margin-bottom:2.8%;" >
  Welcome <?php echo " ";
  				echo $user;
  			?>
</button>
