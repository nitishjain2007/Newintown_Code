...
function giveresultdelay(){
	setTimeout("giveresult()",2000);
}
function giveresult(){
	//alert("hi");
	var lng = document.getElementById('cityLng').value;
	var lat = document.getElementById('cityLat').value;
	window.location="http://localhost/ci/index.php/controller1/query?lng="+lng+"&lat="+lat;
}
function initialize(){
...
<input id="searchTextField" type="text" size="50" style="background:rgba(0,0,0,0);color: white;" onKeydown="Javascript:    if(event.keyCode==13)giveresultdelay();"><br>
